...
// -----------------------------------------------------------------
    ...
    public double darTiempoPromedio(){
        ...
        for (Puesto puesto: puestos){
            if(puesto.estaOcupado()){
                ...
                totalTiempo+=carro1.darTiempoEnParqueadero(horaActual);
            }
        }
        if(totalCarros==0){
            return 0;
    ...
    public boolean hayCarroMasDeOchoHoras() {
        ...
        for (Puesto puesto: puestos){
            if (puesto.estaOcupado()){
                Carro carro1= puesto.darCarro();
                int tiempo= carro1.darTiempoEnParqueadero(horaActual);
                if (tiempo>maxTiempo){
                    carrosPasados8=true;
                }
            }
    ...
    public ArrayList<Carro> darCarrosTresHoras( ) {
        ...
        for (Puesto puesto: puestos){
            if(puesto.estaOcupado()){
                ...
                int tiempo= carro1.darTiempoEnParqueadero(horaActual);
                if (tiempo>limTiempo){
                    carrito3Horas.add(carro1);
                }
            }
        }
        return carrito3Horas;
    }
    public boolean carrosPlacaIgual() {
        ArrayList<String> placas= new ArrayList<>();
        for (Puesto puesto: puestos){
            String placa1= puesto.darCarro().darPlaca();
    ...
    public int carrosPlacaPB (){
        ...
        for(Puesto puesto: puestos){
            if (puesto.estaOcupado()){
                Carro carro1 =puesto.darCarro();
                String placaPB= carro1.darPlaca();
